# MultiCS r1000 v1.40 - by Sharillas
...
> **Verṣo:** v1.40 | **Licen̤a:** Sharillas@2026
...
wget https://github.com/sharillas/MultiCS-r1000-Sharillas/releases/download/v1.40/multics-r1000-v1.40.tar.gz
# 2. extrai e instala
tar xzf multics-r1000-v1.40.tar.gz
cd multics-r1000
